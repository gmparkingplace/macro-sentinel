      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "20px 16px 60px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <AccordionCard icon="📈" title="매크로 경제" score={scores.unemployment}
            ...
            <Row label="CPI YoY"       value={d.macro.cpi_yoy.value != null ? `${fmt(d.macro.cpi_yoy.value)}%` : "—"}   color={d.macro.cpi_yoy.value != null ? d.macro.cpi_yoy.value > 3.5 ? "#c0392b" : d.macro.cpi_yoy.value > 2.0 ? "#b07800" : "#0a8f5c" : undefined} />
            <Row label="Core CPI YoY"  value={d.macro.core_cpi.value != null ? `${fmt(d.macro.core_cpi.value)}%` : "—"} color={d.macro.core_cpi.value != null ? d.macro.core_cpi.value > 3.5 ? "#c0392b" : d.macro.core_cpi.value > 2.0 ? "#b07800" : "#0a8f5c" : undefined} />
            <Row label="PCE YoY"       value={d.macro.pce.value != null ? `${fmt(d.macro.pce.value)}%` : "—"} color={d.macro.pce.value != null ? d.macro.pce.value > 3.5 ? "#c0392b" : d.macro.pce.value > 2.0 ? "#b07800" : "#0a8f5c" : undefined} />
